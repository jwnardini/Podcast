...
<head>
  ...
  <?php endif; ?>
  <link href='https://fonts.googleapis.com/css?family=Passion+One:400,700|Source+Sans+Pro:400,300,600italic,700,400italic,300italic' rel='stylesheet' type='text/css'>
  <?php print $styles; ?>
  <?php print $scripts; ?>
