 ...
 */
function WhatHappending_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['WhatHappending_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('WhatHappending sample setting'),
  '#default_value' => theme_get_setting('WhatHappending_example'),
